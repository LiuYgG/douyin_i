# Generated by Django 3.2.4 on 2021-08-08 10:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('webtester', models.CharField(max_length=200, verbose_name='创建人')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('webteststep', models.CharField(max_length=200, verbose_name='用例步骤')),
                ('webtestobjectname', models.CharField(max_length=200, verbose_name='测试对象名称描述')),
                ('webfindmethod', models.CharField(max_length=200, verbose_name='定位方式')),
                ('webevelment', models.CharField(max_length=800, verbose_name='控件元素')),
