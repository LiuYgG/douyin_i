...
class WebcasestepAdmin(admin.TabularInline):
    ...
    list_display = ['webcasename', 'webteststep', 'webtestobjectname', 'webfindmethod', 'webevelment', 'weboptmethod',
                    'webtestdata', 'webassertdata', 'webtestresult', 'create_time', 'id', 'webcase']
    model = Webcasestep
    extra = 1
