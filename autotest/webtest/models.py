...
class Webcase(models.Model):
    ...
    webtester = models.CharField('创建人', max_length=200)
...
class Webcasestep(models.Model):
    ...
    webteststep = models.CharField('用例步骤', max_length=200)
    webtestobjectname = models.CharField('测试对象名称描述', max_length=200)
    webfindmethod = models.CharField('定位方式', max_length=200)
    webevelment = models.CharField('控件元素', max_length=800)
