...
class Appcase(models.Model):
    ...
    appcasename = models.CharField('用例名称', max_length=300)
    apptestresult = models.CharField('测试结果', max_length=200)
    apptester = models.CharField('创建人', max_length=150)
...
class Appcasestep(models.Model):
    ...
    appteststep = models.CharField('测试步骤', max_length=300)
    ...
    appoptmenthod = models.CharField('操作方法', max_length=200)
    apptestdata = models.CharField('测试数据', max_length=300, null=True)
    appassertdata = models.CharField('验证数据', max_length=200, null=True)
