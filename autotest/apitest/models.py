...
class Apitest(models.Model):
    ...
    # 关联产品 ID ，其中 product 是应用名，Product是product应用的表名
...
class Apistep(models.Model):
    ...
    REQUEST_METHOD = ('get', 'get'), ('post', 'post'), ('put', 'put'), ('delete', 'delete'), ('path', 'path')
...
class Apis(models.Model):
    Product = models.ForeignKey('product.Product', on_delete=models.CASCADE, null=True)
    apiname = models.CharField('接口名称', max_length=64) #接口名称
    apiurl = models.CharField('请求URL地址', max_length=200) #地址
    apiparamvalues = models.CharField('请求参数值', max_length=800) #请求参数好值
    REQUEST_METHOD = ('0', 'get'), ('1', 'post'), ('2', 'put'), ('3', 'delete'), ('4', 'path')
    apimothod = models.CharField(verbose_name='请求方法', choices=REQUEST_METHOD, default='0', max_length=200, null=True) #请求方法
    apiresult = models.CharField('预期结果', max_length=200) #预期结果
    apistatus = models.BooleanField('是否通过') #测试结果
    create_time = models.DateTimeField('创建时间', auto_now=True) #创建时间，自动获取当前时间
