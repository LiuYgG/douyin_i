            ...
            try:
                ...
                try:
                    ...
                    if send_message is not None:
                        ...
                        time.sleep(3)
                        # 窗口-发送邀约按钮
                        send_me = self.d.find_element(By.XPATH,'/html/body/div[3]/div/div[2]/div/div/div[3]/div/div[2]/button[1]')
                        send_me.click()
                ...
                daren_profile = self.d.find_element(By.CLASS_NAME, 'daren-overview-base-traitblock').text # 达人的粉丝数
                daren_contact = contact_info_block.text  # 达人的联系方式

                print(f'姓名：{daren_name} | 粉丝数：{daren_profile}| 联系方式: {daren_contact} | 网址：{self.d.current_url}')

                self.data_list.append({'姓名': daren_name,'粉丝数': daren_profile,'联系方式': daren_contact,'网址': self.d.current_url})
